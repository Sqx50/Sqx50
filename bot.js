...
setInterval(() => {
  http.get(`http://bot3335.glitch.me/`);
}, 280000);
...
const youtube = new YouTube("AIzaSyCZK1LacSQl5A90uLbIhvyTMbrZvMvV-AQ");
...
const dev = ["561603836326707250"]; ///تعديل مهم ايدي حسابك
const admin = "=";
var owner = "561603836326707250"; // Owner Bot Mention /// تعديل مهم ايدي حسابك
var number = "!"; // Unmber Bot
var ex = "2019/10/08";
    ...
    message.guild.fetchInvites().then(invs => {
      ...
      var inviteInfo = new Discord.RichEmbed()
        ...
        .addField(
          ...
          `**➥** [ **https://discord.gg/${inviteCode || "tnmSZMY"}** ]   `
        )
        .setImage(
          ""
        )
...
let room = "672166058940956737"; //تعديل مهم ايدي روم عد الاعضاء والترحيب ، روم صوتي
  ...
  if (msg.content.startsWith("رابط")) {
    ...
    let invite = await msg.channel
      .createInvite(
        {
          //  create invites
          maxAge: (0), // one day // limit time for invite ^^
          maxUses: 0 // 5 people can enter // limit users for invites ^^
        },
    ...
    msg.author.send(
      invite
        ? /*seccussfull*/ `**مدة الرابط : يـوم عدد استخدامات الرابط :  0**:\n ${invite}` /*error catch*/
        : "يوجد خلل في البوت :( \n  يتم حل المشكل قريبا ..."
    );
  }
});
...
client.on("message", message => {
  if (message.content.startsWith(`<@${client.user.id}>`)) {
    ...
    let mention = new Discord.RichEmbed()
      ...
      .setDescription(
        ` ✽  **Hi I'm System Bot**  
✽  **Support Server** [ https://discord.gg/tnmSZMY ] 
✽  **Video explained ** [ https://discord.gg/tnmSZMY ] 
✽  **Bot orders** [ • **=help** • ]   `
      )
...
client.on("guildMemberAdd", member => {
  ...
  var embed = new Discord.RichEmbed()
    ...
    .setColor("RANDOM");
  var channel = member.guild.channels.find("name", "welcom"); //تعديل مهم اسم روم الولكم
  if (!channel) return;
...
client.on("message", msg => {
  if (msg.content === "باك") {
    msg.reply("** احلى من يرجع  :sparkling_heart: :wink:**  ");
  }
});


client.on("message", msg => {
  if (msg.content === "افضل سيرفر") {
    msg.reply("** اكيد سيرفر كنق لايف  :sparkling_heart: :wink:**  ");
  }
});

client.on("message", msg => {
  if (msg.content === "هاي") {
    msg.reply("** هااياات   :kissing_heart: :heart: **");
  }
});

client.on("message", msg => {
  if (msg.content === "هلا") {
    msg.reply("**ي هلابك :heart: **");
  }
});

client.on("message", msg => {
  if (msg.content === "رابط") {
    msg.reply("** https://discord.gg/fF3cE5p :heart: **");
  }
});
...
client.on("message", msg => {
  if (msg.content === "تسجيل خروج") {
    msg.reply("**  ``تم تسجيل خروجك ``:heart **");
  }
});
...
client.on("message", msg => {
  if (msg.content === "كس امك") {
    msg.reply("** 😘 الله يهديك ي ابن الكلب **");
  }
});

client.on("message", msg => {
  if (msg.content === "طاط") {
    msg.reply("**  احبكك ي حماارر` طااط` **");
  }
});

client.on("message", msg => {
  if (msg.content === "طاط") {
    msg.reply("**  https://i.imgur.com/ssAJrWM.png**");
  }
});

client.on("message", msg => {
  if (msg.content === "مساعدة") {
    msg.reply("**اذا تبي مساعدة ي جميل افتح تيكت```اعضاء الدعم الفني تحت الخدمة```**");
  }
});

client.on("message", msg => {
  if (msg.content === "ابي مساعدة") {
    msg.reply("**اذا تبي مساعدة ي جميل افتح تيكت```اعضاء الدعم الفني تحت الخدمة```**");
  }
});

client.on("message", msg => {
  if (msg.content === "ابغى مساعدة") {
    msg.reply("**اذا تبي مساعدة ي جميل افتح تيكت```اعضاء الدعم الفني تحت الخدمة```**");
  }
});

client.on("message", msg => {
  if (msg.content === "ابغى مساعده") {
    msg.reply("**اذا تبي مساعدة ي جميل افتح تيكت```اعضاء الدعم الفني تحت الخدمة```**");
  }
});

client.on("message", msg => {
  if (msg.content === "ابي مساعده") {
    msg.reply("**اذا تبي مساعدة ي جميل افتح تيكت```اعضاء الدعم الفني تحت الخدمة```**");
  }
});

client.on("message", msg => {
  if (msg.content === "مساعده") {
    msg.reply("**اذا تبي مساعدة ي جميل افتح تيكت```اعضاء الدعم الفني تحت الخدمة```**");
  }
});
...
client.on("guildCreate", guild => {
  var embed = new Discord.RichEmbed().setImage(
   ...
   ✽ **Support Server** [ • https://discord.gg/tnmSZMY • ]  ✽ `); //تعديل مهم رابط سيرفرك
...
julian.on("message", codes => {
  if (codes.content.startsWith(prefix + "on")) {
    if (
      codes.author.bot ||
      !codes.channel.guild ||
    ...
    codes.channel.send("تم تفعيل عدم دخول البوت");
  }
  if (codes.content.startsWith(prefix + "off")) {
    if (
      codes.author.bot ||
      !codes.channel.guild ||
      codes.author.id != codes.guild.ownerID
    ...
    codes.channel.send("تم تعطيل عدم دخول البوت");
  }
});
...
client.on('message', async message => {//Shady Craft YT#4176
    ...
    const embed500 = new Discord.RichEmbed()
      .setTitle("Muted Ads")
            .addField(`**  تم اعطائك ميوت **` , `**Reason : ل نشرك سيرفر اخر**`)
            .setColor("c91616")
            .setThumbnail(`${message.author.avatarURL}`)
            .setAuthor(message.author.username, message.author.avatarURL)
        .setFooter(`${message.guild.name} `)
     message.channel.send(embed500)
     message.author.send('` انت معاقب ميوت شات بسبب نشر سيرفرات ان كان عن طريق الخطا--توجه الى الادارة `');
...
client.on("message", message => {
  if (message.content.startsWith("📩")) {
    const reason = message.content
      ...
      .slice(1)
      .join(" ");
    if (!message.guild.roles.exists("name", "✹ | 𝓢𝓣𝓐𝓕𝓕 𝓣𝓔𝓐𝓜💎"))
      return message.channel.send(
        `This server doesn't have a \`✹ | 𝓢𝓣𝓐𝓕𝓕 𝓣𝓔𝓐𝓜💎\` role made, so the ticket won't be opened.\nIf you are an administrator, make one with that name exactly and give it to users that should be able to see tickets. لازم تسوي رتبة اسمها \`𝑻𝑰𝑪𝑲𝑬𝑻 𝑴𝑨𝑵𝑨𝑮𝑬𝑹✔️\`.`
      );
    if (
    ...
    message.guild
      .createChannel(`تم فتح التذكرة -${message.author.username}`, "text")
      .then(c => {
        let role = message.guild.roles.find("name", "✹ | 𝓢𝓣𝓐𝓕𝓕 𝓣𝓔𝓐𝓜💎");
        ...
        message.channel.send(
          `:white_check_mark: ‼اتمنى عدم الفتح اكثر من مررة ‼, #${c.name}.`
        );
        const embed = new Discord.RichEmbed()
          .setColor(0xcf40fa)
          .addField(
            `Hey ${message.author.username}!`,
            ` ❤ نرجو منك انتظار الرد من احد الاعضاء املين منك الانتظار بعد كتب مشكلة لحل مشكلتك .`
          )
          .setTimestamp();
        c.send({
          embed: embed
